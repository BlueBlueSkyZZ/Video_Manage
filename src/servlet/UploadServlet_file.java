...
public class UploadServlet_file extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public UploadServlet_file() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(e.getMessage().indexOf("1015") != -1){
				result = "上传失败：上传视频类型不正确！请上传zip或rar!";
		...
		String myurl =  "/JSP/Teacher/adminAddFile.jsp?lesson_id="+lesson_id+"&lesson_name"+lesson_name;
		//String myurl =  "/JSP/Teacher/adminAddFile.jsp?lesson_name="+lesson_name;
		request.getSession().setAttribute("file_url", url.toString());//将用户名存储到会话中
